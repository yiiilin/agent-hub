...
| 服务 | 默认镜像 |
| --- | --- |
| Hub 与管理台 | `ghcr.io/yiiilin/agent-hub:0.4.3` |
| Runtime 与 Pi standalone | `ghcr.io/yiiilin/agent-hub-runtime:0.4.3` |
...
```bash
gh workflow run Release --ref main -f release_tag=v0.4.3
```
