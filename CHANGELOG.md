...
- 浏览器 SDK（`@agent-hub/client`）以 tarball 形式随 GitHub Release 发布（含 SHA256SUMS），第三方应用可按固定版本直接安装，无需自建内部 registry。
...
- 模型代理请求体上限提升至 64MB，并记录请求体大小（大附件/大工具结果请求不再被拒）。
...
[0.4.3]: https://github.com/yiiilin/agent-hub/compare/v0.3.13...v0.4.3
